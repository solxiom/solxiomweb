...
import com.solxiom.article.connection.entity.LoginObject;
import com.solxiom.article.connection.entity.ResponseObject;
...
public class ConnectionController {
	...
	public String doLogout(@RequestParam("facebook") String facebook,
